...
/**
 * This custom Java class has function to check whether user's password pass all 
...
this.name = firstname+lastname;
    ...
    /**
     * Method to check whether a password contained in the given username
...
return result;
    ...
    /**
     * Method to check whether a password contained in the given name
     * @return true or false
     */
...
return result;
     ...
     * For the details of the requirements please refer to the link above this class
     * @return true or false
     */
