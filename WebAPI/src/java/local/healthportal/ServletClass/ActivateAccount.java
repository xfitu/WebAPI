...
/**
 * This Servlet class is used to activate user's account in Active Directory
 * this Servlet class is triggered when user click on the verification link 
 * which is sent in the email content
 * @author Julio Vaz
 */
...
try {
    ...
    /**
     * Servlet class information method
     * @return
     */
    @Override
    ...
    /**
     * method to activate account user account in Active Directory
     * @param fname
     * @param lname
