...
/**
 * This Servlet class is used to update user's username or account or login name in Active Directory
 * @author Julio Vaz
 */
...
//method to update user's username or account in active directory
    /**
     * Method to update user's username or login name in active directory
     * @param name
     * @param newusername
